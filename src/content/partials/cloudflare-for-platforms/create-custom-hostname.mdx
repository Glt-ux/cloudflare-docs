...
5. Add your customer's hostname `app.customer.com` and set the relevant options, including:
   ...
   * Defining whether you want to use a certificate provisioned by Cloudflare or [upload a custom certificate](/cloudflare-for-platforms/cloudflare-for-saas/security/certificate-management/custom-certificates/uploading-certificates/)
   * Selecting the [Certificate Autority](/ssl/reference/certificate-authorities/) that will provision the certificate
