...
3. Click on the domain for which you want to configure variables. 
...
2. Go to **Tag Management** > **Tag Setup**
3. Click on the domain for which you want to configure variables. 
4. Click **Third-party tools**.
5. Click **Edit** next to a tool that you have already configured.
6. Select an action or add a new one.
7. Click on the plus sign at the right of the text fields.
8. Select your Worker Variable from the list.
