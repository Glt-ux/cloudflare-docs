...
While your [DNS records](/dns/manage-dns-records/test/) make your website or application available to visitors and other web services, the **Proxy status** of a DNS record defines how Cloudflare treats incoming DNS queries for that record.
