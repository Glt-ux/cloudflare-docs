...
- [Created A Turnstile widget](/turnstile/get-started/#1-create-your-widget) and obtained a sitekey
...
- If you have simple implementations and want a quick integration
- If you have static websites with straightforward forms
- If you want widgets to appear immediately on pageload
- If you do not need programmatic control of the widget
...
- If you have dynamic websites and single-page applications (SPAs)
- If you need to control the timing of widget creation
- If you want to conditionally render the widget based on visitor interactions
- If you want multiple widgets with different configurations
- If you have complex applications requiring widget lifecycle management
