...
4. Select **Next**.
5. In this section, you can choose whether to enable [Turnstile](/turnstile/) for your waiting room. If you select **Yes**, you will need to choose your [Widget mode](/turnstile/concepts/widgets/) and define the action to take if a turnstile challenge fails. The available Widget modes and actions depend on your plan type. Refer to the [Plans](/waiting-room/plans/) for more details.
